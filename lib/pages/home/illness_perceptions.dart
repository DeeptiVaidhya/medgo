...
class IllnessPerceptions extends StatefulWidget {
  @override
  _IllnessPerceptionsState createState() => _IllnessPerceptionsState();
}

class _IllnessPerceptionsState extends State<IllnessPerceptions> {
  double value = 6.0;
  var datamap = Map();
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: header("Illness perceptions", context, true, true, false, true),
        body: SingleChildScrollView(
          child: sliderQueCard(context),
        ),
  ...
  Container sliderQueCard(BuildContext context) {
    return Container(
      child: Center(
        child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "How much does your sickle cell disease affect your life?",
                      textAlign: TextAlign.left,
                      style: AppCss.black20bold,
                    ),
                  ),
                  Text(
                      "Please select a number on the scale below between 0 and 5.",
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        button(true, 100, 33, "Finish", AppCss.black14bold,
                            AppColors.AQUA_BLUE, () {
